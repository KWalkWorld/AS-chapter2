...
public class Exercises3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRvMain = findViewById(R.id.rv_list);
        ...
        mRvMain.setLayoutManager(new LinearLayoutManager(Exercises3.this));
        mRvMain.setAdapter(new RvE3Adapter(Exercises3.this, messages));
